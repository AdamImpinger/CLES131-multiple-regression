...
where the likelihood is a metric of model fit and the penalty is a meetric of model complexity. One common information criterion you may encounter is the AIC, or Akaike Information Criterion:

$AIC = -2ln(L) + 2k$

where ln(L) is the log-likelihood and k is the number of parameters in the model. 
